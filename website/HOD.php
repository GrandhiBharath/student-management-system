    ...
    <div>
        <form method="POST" action="process.php">
            <div id="options">
                ...
                <select name="h_branch" id="branch">
                    <option value=""></option>
            ...
            <div id="options">
                <label for="sem"> Choose the Semester: </label>
                <select name="h_sem" id="sem">
                    <option value=""></option>
                    <option value="1">1st Semester</option>
                    <option value="2">2nd Semester</option>
                </select><br><br><br>
            </div>
            <button name="hod_submit">Submit</button>
        </form>
